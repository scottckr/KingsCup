...
let defaultRules = ["1" : "Vattenfall: Alla börjar dricka, spelaren som drog kortet får sluta dricka när den vill, spelaren efter får inte sluta förrän spelaren som drog kortet har slutat dricka, detta fortsätter laget runt medurs.",
